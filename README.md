...
python mapgen.py 東京 --gif --scale 80
...
# 全部盛り
python mapgen.py ウラジオストク --gif --scale 60 --force-moon --force-ufo --force-direction right-to-center
```
...
| `--scale` | 解像度スケール: 50/60/70/80/90/100（デフォルト: GIF=60, PNG=100） |
